...
*/
  ...
  function handleCloseMovie() { // fungsi close/kembali di movie " <- ""
    setSelectedId(null);
  }

  function handleAddWatched(movie) { // untuk add di watched
    setWatched((watched) => [...watched, movie]);
  }

  function handleDeleteWatched(id) { // delete di watched
